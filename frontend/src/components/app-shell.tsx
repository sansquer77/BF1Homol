...
import { TimezoneProvider, TimezoneSelector } from "@/lib/timezone-context";
...
const groups: Group[] = [
  ...
  { label: "Administração", items: [{ label: "Cadastros", href: "/admin", icon: GridIcon, roles: ["admin", "master"] }, { label: "Resultados", href: "/admin/resultados", icon: FlagIcon, roles: ["admin", "master"] }, { label: "Gestão de apostas", href: "/admin/apostas", icon: TrophyIcon, roles: ["admin", "master"] }, { label: "Apostas do campeonato", href: "/admin/campeonato", icon: TrophyIcon, roles: ["admin", "master"] }, { label: "Regras", href: "/admin/regras", icon: BookIcon, roles: ["master"] }, { label: "Financeiro", href: "/admin/financeiro", icon: ChartIcon, roles: ["master"] }, { label: "Hall da Fama", href: "/admin/hall-da-fama", icon: TrophyIcon, roles: ["master"] }, { label: "Backup e restauração", href: "/admin/backup", icon: BookIcon, roles: ["master"] }] },
];
