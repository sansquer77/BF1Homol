...
@ttl_cache(ttl=60, tags=("calendar",))
def _cached_calendar(season: str) -> list[dict[str, Any]]:
...
def calendar(
    ...
    return [RaceResponse.model_validate(item) for item in _cached_calendar(season)]
